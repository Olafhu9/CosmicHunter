...
#with open('/home/juhee5819/cheer/CosmicHunter/result.txt', "a") as f_log:
#    f_log.write("\n"+result+'\n')

txtf = std.ofstream('/home/juhee5819/cheer/CosmicHunter/result.txt')
result.floatParsFinal().printMultiline(txtf, 1111, True)
#result.floatParsFinal().printValue(txtf)
txtf.close()
